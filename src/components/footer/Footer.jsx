...
const Footer = () => <footer className="page-footer text-warning bg-dark font-small pt-4">
            ...
            <div className="col-md-3 mb-md-0 mb-3">
                ...
                <ul className="list-unstyled">
                    <li><a className="text-warning"
                              ...
                              target="_blank"
                              style={{fontWeight:"bold"}}>KZENGINE AI Engine
                        </a>
                    </li>
    ...
    <div className="footer-copyright text-center py-3">© 2023 Copyright:
        <a className="text-warning" href="#!" style={{fontWeight:"bold"}}>KAYZEE CORP.</a>
    </div>
